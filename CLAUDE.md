...
- Research entries on `research.html` follow a fixed pattern: `.paper` div with title, status note (journal status / coauthor), optional PDF link, and abstract inside `<details>`. New papers should copy this pattern.
